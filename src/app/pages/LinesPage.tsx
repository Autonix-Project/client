          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-destructive/80">
                {faultLines.length}개 라인에서 장애가 발생했습니다:{' '}
                {faultLines.map(l => l.lineName).join(', ')}
              </p>
            </div>
          </div>
        </div>
